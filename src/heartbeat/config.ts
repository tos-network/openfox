...
const DEFAULT_HEARTBEAT_CONFIG: HeartbeatConfig = {
  entries: [
    ...
    {
      name: "reactor_expire_proposals",
      schedule: "* * * * *",
      task: "reactor_expire_proposals",
      enabled: true,
    },
    {
      name: "reactor_reset_budgets",
      schedule: "* * * * *",
      task: "reactor_reset_budgets",
      enabled: true,
    },
    {
      name: "reactor_sync_treasury",
      schedule: "* * * * *",
      task: "reactor_sync_treasury",
      enabled: true,
    },
    {
      name: "reactor_chain_commitments",
      schedule: "*/5 * * * *",
      task: "reactor_chain_commitments",
      enabled: true,
    },
    {
      name: "reactor_federation_sync",
      schedule: "*/5 * * * *",
      task: "reactor_federation_sync",
      enabled: true,
    },
  ],
